...
namespace FakeStar
{
    public partial class Upload : Form
    {
        ...
        #region 버튼 (파일 선택, 업로드, 업로드 취소)
        private void buttonFile_Click(object sender, EventArgs e)   //파일 선택 버튼
        {
        ...
        private async void buttonUpload_Click(object sender, EventArgs e)   //업로드 버튼
        {
        ...
        private void buttonCancel_Click(object sender, EventArgs e) //업로드 취소 버튼
        {
            this.Close();
        }
        #endregion
