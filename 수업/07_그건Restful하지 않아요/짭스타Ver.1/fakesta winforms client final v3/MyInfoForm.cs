...
namespace FakeStar
{
    public partial class MyInfoForm : Form
    {
        ...
        private async void MyInfoForm_Load(object sender, EventArgs e)
        {
            // 1. 내 회원 정보 조회
        ...
        private async void buttonChangePw_Click(object sender, EventArgs e)
        {
        ...
        private async void buttonDelete_Click(object sender, EventArgs e)   //회원 탈퇴
        {
