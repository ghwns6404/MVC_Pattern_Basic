...
namespace WoosongBit41.Lib
{
    internal static class WbLib
    {
        ...
        public static ConsoleKey MenuPrint()
        {
            ...
            Console.WriteLine("[F1] 점수 저장");
            Console.WriteLine("[F2] 점수 검색");
            Console.WriteLine("[F3] 점수 수정");
            Console.WriteLine("[F4] 점수 삭제");
            Console.WriteLine("[F5] 점수 검색(Join)");
            Console.WriteLine("[F6] 과목 중 가장 높은 점수 검색");
            Console.WriteLine("*************************************************************************");
