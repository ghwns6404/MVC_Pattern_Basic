...
struct tag_people {
	...
	{"김상형","123-4567","서울시 강남구 논현동",TRUE,1},
	{"이송우","543-9876","서울시 구의동",TRUE,3},
	{"박다희","111-3333","경기도 광명시",FALSE,2},
	{"오궁섭","236-1818","서울시 강남구 반포동",TRUE,0},
	{"조기순","358-2277","서울시 압구정동",FALSE,0},
	{"오뱅훈","548-1109","서울시 신사동",TRUE,3},
};
...
LRESULT CALLBACK WndProc(HWND hWnd,UINT iMessage,WPARAM wParam,LPARAM lParam)
{
	...
	LVITEM LI;
	int i;
	HIMAGELIST hImgSm, hImgLa, hImgSt;
	static HWND hList;
	...
	case WM_CREATE:
		...
		hImgSt=ImageList_LoadBitmap(g_hInst, MAKEINTRESOURCE(IDB_STATE), 
			16, 1, RGB(255,255,255));
		ListView_SetImageList(hList, hImgSm, LVSIL_SMALL);
		ListView_SetImageList(hList, hImgLa, LVSIL_NORMAL);
		ListView_SetImageList(hList, hImgSt, LVSIL_STATE);
		...
		for (i=0;i<sizeof(people)/sizeof(people[0]);i++) {
			...
			LI.state=INDEXTOSTATEIMAGEMASK(people[i].iGrade);
			LI.iItem=i;
			LI.iSubItem=0;
