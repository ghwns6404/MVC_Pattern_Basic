...
HINSTANCE g_hInst;
HWND hWndMain;
LPCTSTR lpszClass=TEXT("PostList2");
...
/*		// 트리 뷰의 여러 가지 속성을 설정한다.
		TreeView_SetTextColor(hTree,RGB(255,0,0));
		TreeView_SetBkColor(hTree,RGB(222,222,255));
		TreeView_SetItemHeight(hTree,30);
		TreeView_SetIndent(hTree,20);
		TreeView_SetLineColor(hTree,RGB(0,255,0));
//*/
		return 0;
	case WM_DESTROY:
